            ...
            <div id="shawlCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="./src/assets/images/Homepage-1.jpg" class="d-block w-100" alt="Shawl 1">
                    </div>
                    <div class="carousel-item">
                        <img src="./src/assets/images/Homepage2.jpg" class="d-block w-100" alt="Shawl 2">
                    </div>
                    <div class="carousel-item">
                        <img src="./src/assets/images/homepage3.jpg" class="d-block w-100" alt="Shawl 3">
                    </div>
                    <div class="carousel-item">
                        <img src="./src/assets/images/homepage4.jpg" class="d-block w-100" alt="Shawl 4">
                    </div>
                    <div class="carousel-item">
                        <img src="./src/assets/images/homepage5.jpg" class="d-block w-100" alt="Shawl 5">
                    </div>
                    <div class="carousel-item">
                        <img src="./src/assets/images/homepage6.jpg" class="d-block w-100" alt="Shawl 6">
                    </div>
